...
public abstract class Part implements Serializable {
    ...
    double price;
    static Integer minInventory = 0;
    @Min(value = 1, message = "Inventory value must be greater than 1")
    int inv;
    @Max(value =30, message="Too much inventory sitting around already")
    static Integer maxInventory = 30;
    ...
    public static boolean minBounds(int inv) {
    ...
    public static boolean maxBounds(int inv) {
        if (inv > maxInventory) {
            return false;
        }
        else { return true; }
